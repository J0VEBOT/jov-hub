...
JovHub can post Discord embeds when skills are published or highlighted.
...
- `SITE_URL` (optional): Base site URL for links (default `https://hub.j0vebot.com`).
  ...
  "embeds": [
    {
      ...
      "url": "https://hub.j0vebot.com/owner/demo-skill",
      "fields": [
