...
Base URL: `https://hub.j0vebot.com` (default).
...
## Registry discovery (`/.well-known/jovhub.json`)

The CLI can discover registry/auth settings from the site:

- `/.well-known/jovhub.json` (JSON, preferred)
- `/.well-known/jovhub.json` (legacy)

Schema:

```json
{ "apiBase": "https://hub.j0vebot.com", "authBase": "https://hub.j0vebot.com", "minCliVersion": "0.0.5" }
```
