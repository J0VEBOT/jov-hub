...
export function getFallbackSkillRoots(workdir: string) {
  ...
  const roots = [
    ...
    resolve(workdir, '..', 'jovis', 'skills'),
    resolve(workdir, '..', 'jovis', 'Skills'),
    resolve(workdir, '..', 'jovbot', 'skills'),
    resolve(workdir, '..', 'jovbot', 'Skills'),
    resolve(workdir, '..', 'J0VEBOT', 'skills'),
    resolve(workdir, '..', 'J0VEBOT', 'Skills'),
    resolve(workdir, '..', 'moltbot', 'skills'),
    resolve(workdir, '..', 'moltbot', 'Skills'),

    // legacy locations
    resolve(home, 'jovebot', 'skills'),
    resolve(home, 'jovebot', 'Skills'),
    resolve(home, '.jov', 'skills'),
    resolve(home, '.jov', 'Skills'),

    resolve(home, 'jovbot', 'skills'),
    resolve(home, 'jovbot', 'Skills'),
    resolve(home, '.jovbot', 'skills'),
    resolve(home, '.jovbot', 'Skills'),

    resolve(home, 'jovis', 'skills'),
    resolve(home, 'jovis', 'Skills'),
    resolve(home, '.jovis', 'skills'),
    resolve(home, '.jovis', 'Skills'),

    resolve(home, 'J0VEBOT', 'skills'),
    resolve(home, 'J0VEBOT', 'Skills'),
    resolve(home, '.J0VEBOT', 'skills'),
    resolve(home, '.J0VEBOT', 'Skills'),
    ...
    resolve(home, 'Library', 'Application Support', 'jovbot', 'skills'),
    resolve(home, 'Library', 'Application Support', 'jovbot', 'Skills'),
    resolve(home, 'Library', 'Application Support', 'jovis', 'skills'),
    resolve(home, 'Library', 'Application Support', 'jovis', 'Skills'),
    resolve(home, 'Library', 'Application Support', 'J0VEBOT', 'skills'),
    resolve(home, 'Library', 'Application Support', 'J0VEBOT', 'Skills'),
