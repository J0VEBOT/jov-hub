...
export const JOVConfigSpecSchema = type({
  requiredEnv: 'string[]?',
  stateDirs: 'string[]?',
  example: 'string?',
})
export type JOVConfigSpec = (typeof JOVConfigSpecSchema)[inferred]

export const JOVisRequiresSchema = type({
  bins: 'string[]?',
  anyBins: 'string[]?',
  env: 'string[]?',
  config: 'string[]?',
})
export type JOVisRequires = (typeof JOVisRequiresSchema)[inferred]

export const JovisSkillMetadataSchema = type({
  always: 'boolean?',
  skillKey: 'string?',
  primaryEnv: 'string?',
  emoji: 'string?',
  ...
  os: 'string[]?',
  cliHelp: 'string?',
  requires: JOVisRequiresSchema.optional(),
  install: SkillInstallSpecSchema.array().optional(),
  nix: NixPluginSpecSchema.optional(),
  config: JOVConfigSpecSchema.optional(),
})
export type JovisSkillMetadata = (typeof JovisSkillMetadataSchema)[inferred]
