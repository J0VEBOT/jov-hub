...
import { parseJOVisMetadata, parseFrontmatter } from './lib/skills'
...
\`\`\`bash
padel  # On PATH (jovbot plugin bundle)
\`\`\`
...
`,
    ...
    rawSkillMd: `---
name: gohome
description: Use when JOV needs to test or operate GoHome via gRPC discovery, metrics, and Grafana.
---
