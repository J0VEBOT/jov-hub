      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-copy fade-up" data-delay="1">
            <span className="hero-badge">Bolt-light. Agent-right.</span>
            <h1 className="hero-title">JovHub, the skill dock for sharp agents.</h1>
      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-copy fade-up" data-delay="1">
            ...
            <h1 className="hero-title">JovSouls, where system lore lives.</h1>
            <p className="hero-subtitle">
