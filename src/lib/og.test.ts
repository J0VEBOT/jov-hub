...
describe('og helpers', () => {
  ...
  it('builds metadata with owner and summary', () => {
    ...
    expect(meta.title).toBe('Weather — JovHub')
  ...
  it('builds soul metadata with summary', () => {
    ...
    expect(meta.title).toBe('North Star — JovSouls')
  ...
  it('uses defaults when owner and summary are missing', () => {
    ...
    expect(meta.title).toBe('parser — JovHub')
    expect(meta.description).toMatch(/JovHub — a fast skill registry/i)
  ...
  it('uses soul defaults when owner and summary are missing', () => {
    ...
    expect(meta.title).toBe('signal — JovSouls')
    expect(meta.description).toMatch(/JovSouls — the home for SOUL.md/i)
