...
import { getJovHubSiteUrl, getSiteMode, getSiteName } from '../lib/site'
...
export default function Header() {
  ...
  const clawHubUrl = getJovHubSiteUrl()
      ...
      <div className="navbar-inner">
        ...
        >
          <span className="brand-mark">
            <img src="/jov-logo.png" alt="" aria-hidden="true" />
          </span>
          <span className="brand-name">{siteName}</span>
        </Link>
        <nav className="nav-links">
          {isSoulMode ? <a href={clawHubUrl}>JovHub</a> : null}
          {isSoulMode ? (
            <Link
              to="/souls"
              search={{
